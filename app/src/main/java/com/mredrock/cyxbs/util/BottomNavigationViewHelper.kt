...
open class BottomNavigationViewHelper(nav: BottomNavigationView) {
    ...
    private fun reflectLargeLabels(): Array<TextView>? {
        try {
            ...
            LogUtils.LOGE(javaClass.name, "reflect field \"mLargeLabel\" failed", e)
        }
        return null
    }
    ...
    private fun reflectSmallLabels(): Array<TextView>? {
        try {
            ...
            LogUtils.LOGE(javaClass.name, "reflect field \"mSmallLabel\" failed", e)
        }
        return null
    }
    ...
    private fun reflectIcons(): Array<ImageView>? {
        try {
            ...
            LogUtils.LOGE(javaClass.name, "reflect field \"mIcon\" failed", e)
        }
        return null
    }
    ...
    private fun setField(obj: Any?, fieldName: String, value: Any) {
        ...
        try {
            ...
            LogUtils.LOGE(javaClass.name, "reflect field \"$fieldName\" failed", e)
        }
    }
